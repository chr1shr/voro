...
class pre_container_base {
    public:
        ...
        pre_container_base(double ax_,double bx_,double ay_,double by_,double az_,double bz_,bool x_prd_,bool y_prd_,bool z_prd_,int ps_);
        ~pre_container_base();
    ...
    protected:
        /** The number of doubles associated with a single particle (three for
         * the standard container, four when radius information is stored). */
        const int ps;
        void new_chunk();
...
class pre_container : public pre_container_base {
    public:
         ...
         * initializing the minimum and maximum coordinates in each direction.
         * \param[in] (ax_,bx_) the minimum and maximum x coordinates.
         * \param[in] (ay_,by_) the minimum and maximum y coordinates.
         * \param[in] (az_,bz_) the minimum and maximum z coordinates.
         * \param[in] (x_prd_,y_prd_,z_prd_) flags setting whether the
         *                                   container is periodic in each
         *                                   coordinate direction. */
        pre_container(double ax_,double bx_,double ay_,double by_,double az_,double bz_,
                bool x_prd_,bool y_prd_,bool z_prd_)
            : pre_container_base(ax_,bx_,ay_,by_,az_,bz_,x_prd_,y_prd_,z_prd_,3) {};
...
class pre_container_poly : public pre_container_base {
    public:
        ...
        pre_container_poly(double ax_,double bx_,double ay_,double by_,double az_,double bz_,
                bool x_prd_,bool y_prd_,bool z_prd_)
            : pre_container_base(ax_,bx_,ay_,by_,az_,bz_,x_prd_,y_prd_,z_prd_,4) {};
