...
class c_loop_base {
    public:
        ...
        /** Returns the z position of the particle currently being considered
         * by the loop. */
...
class c_loop_order : public c_loop_base {
    ...
    private:
        ...
        const int nxy;
        /** Takes the current block index and computes indices in the x, y, and
         * z directions. */
        inline void decode() {
            k=ijk/nxy;
            int ijkt=ijk-nxy*k;
