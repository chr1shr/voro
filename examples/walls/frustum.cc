...
int main() {
    ...
    container_3d con(-1.2,1.2,-1.2,1.2,0,1,14,14,7,
                     false,false,false,8);
    ...
    // Place particles in a regular grid within the frustum, for points that 
    // are within the wall boundaries
    ...
    // Compute the volume of the Voronoi cells and compare it to the exact
    // frustum volume
