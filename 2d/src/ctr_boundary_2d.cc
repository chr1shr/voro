...
container_boundary_2d::container_boundary_2d(double ax_,double bx_,double ay_,double by_,
    ...
    vc(*this,x_prd_?2*nx_+1:nx_,y_prd_?2*ny_+1:ny_)    {
    int l;
//        totpar=0;
 ...
 * proceed to setup **wid, *soi, and THE PROBLEM POINTS BOOLEAN ARRAY. This
 * algorithm keeps the importing seperate from the set-up */
